    ...
    <div className="min-h-screen bg-paper text-ink font-sans selection:bg-[#d49a38]/30 selection:text-ink">
      ...
      <section className="relative pt-[120px] pb-[80px] overflow-hidden">
        ...
        <div className="max-w-[1216px] w-[calc(100%-48px)] mx-auto relative z-10 text-white text-center">
          <p className="text-[#d49a38] font-bold uppercase tracking-[2px] text-[12px] mb-4">PropertiesNexus</p>
          ...
          <p className="text-[16px] md:text-[18px] text-white/80 max-w-2xl mx-auto leading-relaxed mb-10">
            We connect discerning buyers with exceptional properties, offering a curated platform built on trust, verified listings, and a seamless digital experience.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1216px] w-[calc(100%-48px)] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="p-6 text-center border-b md:border-b-0 md:border-r border-line">
              <div className="text-[#d49a38] text-[36px] mb-2 flex justify-center"><Users size={40} /></div>
              <h3 className="text-[32px] font-serif font-medium text-ink mb-1">50k+</h3>
              <p className="text-[13px] text-muted font-semibold uppercase tracking-wider">Happy Clients</p>
            </div>
            <div className="p-6 text-center border-b md:border-b-0 md:border-r border-line">
              <div className="text-[#d49a38] text-[36px] mb-2 flex justify-center"><Target size={40} /></div>
              <h3 className="text-[32px] font-serif font-medium text-ink mb-1">10k+</h3>
              <p className="text-[13px] text-muted font-semibold uppercase tracking-wider">Properties Sold</p>
            </div>
            <div className="p-6 text-center border-b md:border-b-0 md:border-r border-line">
              <div className="text-[#d49a38] text-[36px] mb-2 flex justify-center"><ShieldCheck size={40} /></div>
              <h3 className="text-[32px] font-serif font-medium text-ink mb-1">100%</h3>
              <p className="text-[13px] text-muted font-semibold uppercase tracking-wider">Verified Listings</p>
            </div>
            <div className="p-6 text-center">
              <div className="text-[#d49a38] text-[36px] mb-2 flex justify-center"><MapPin size={40} /></div>
              <h3 className="text-[32px] font-serif font-medium text-ink mb-1">20+</h3>
              <p className="text-[13px] text-muted font-semibold uppercase tracking-wider">Cities Covered</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-[100px] bg-paper">
        <div className="max-w-[1216px] w-[calc(100%-48px)] mx-auto grid grid-cols-1 md:grid-cols-2 gap-[60px] items-center">
          ...
          <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-2xl">
            <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?auto=format&fit=crop&w=1200&q=80" alt="PropertiesNexus Office" className="w-full h-full object-cover" />
