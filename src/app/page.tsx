  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-paper text-ink font-sans">
      ...
      <main>
        {/* ================= GUIDANCE ================= */}
        <section
          className="py-16 sm:py-20 lg:py-[88px]"
          id="guidance"
        >
        ...
        {/* ================= LISTINGS ================= */}
        <section
          className="bg-[#f8fafc] py-16 sm:py-20 lg:py-[84px]"
          id="properties"
        >
          <div className="mx-auto w-[calc(100%-32px)] max-w-[1216px] sm:w-[calc(100%-48px)]">
            <p className="mb-3 text-[10px] font-bold uppercase tracking-[1.6px] text-[#b57b22]">
            ...
            <div className="flex flex-col items-start justify-between gap-5 lg:flex-row lg:items-end">
              ...
              <Link
                href="/properties"
                className="inline-flex shrink-0 items-center gap-1 rounded-xl bg-navy px-5 py-2.5 text-[12px] font-bold !text-white shadow-sm transition-colors hover:bg-navy2"
              >
            ...
            {loading ? (
              ...
              <div className="mt-7 rounded-xl border border-line bg-white p-8 text-center sm:p-12">
                <p className="mb-4 text-[14px] text-muted sm:text-[15px]">
                  No properties available under "{activeTab}" at the moment.
                </p>
        ...
        {featuredVillas.length > 0 && (
          ...
          >
            <div className="mx-auto w-[calc(100%-32px)] max-w-[1216px] sm:w-[calc(100%-48px)]">
              ...
              <div className="mt-8 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3 lg:mt-10">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 text-center shadow-sm sm:rounded-3xl sm:p-10 lg:p-12">
              ...
              <form
                onSubmit={(e) => {
                  e.preventDefault();
                  alert(
                    "Subscribed! We will notify you of new listings."
                  );
                }}
        ...
        {/* ================= AREAS ================= */}
        <section
          className="py-16 sm:py-20 lg:py-[89px]"
          id="areas"
        >
          <div className="mx-auto grid w-[calc(100%-32px)] max-w-[1216px] grid-cols-1 items-center gap-10 sm:w-[calc(100%-48px)] lg:grid-cols-[1.2fr_1fr] lg:gap-[95px]">
            <div className="min-w-0">
              ...
              <h2 className="font-serif text-[clamp(32px,5vw,49px)] font-medium leading-[1.1] tracking-[-1.8px] text-ink">
                ...
                <br />
                across{" "}
                <em className="not-italic text-[#bd8125]">
                  India.
                </em>
              </h2>

              <p className="my-5 mb-7 max-w-[445px] text-[14px] leading-[1.75] text-muted sm:text-[15px]">
                From familiar city streets to high-potential new
                neighbourhoods, discover locations with a perspective beyond
                the pin on the map.
              </p>
            ...
            <div className="border-t border-line">
              {[
                ...
                <Link
                  key={area.num}
                  href={`/properties?query=${encodeURIComponent(
                    area.name
                  )}`}
        ...
        {/* ================= PARTNERS ================= */}
        <section
          className="bg-navy py-16 text-white sm:py-20 lg:py-[88px]"
          id="agents"
        >
          <div className="mx-auto grid w-[calc(100%-32px)] max-w-[1216px] grid-cols-1 items-center gap-9 sm:w-[calc(100%-48px)] lg:grid-cols-2 lg:gap-[90px]">
            <div className="order-2 min-w-0 lg:order-1">
              ...
              <p className="my-4 max-w-[450px] text-[14px] leading-[1.7] text-[#c5d1dd] sm:text-[15px]">
                ...
                compelling presentation and a team that understands local
                demand.
              </p>
            ...
            <div
              className="order-1 h-[280px] rounded-lg bg-cover bg-center sm:h-[350px] lg:order-2 lg:h-[390px]"
              style={{
                backgroundImage:
      ...
      {/* ================= FLOATING BAR ================= */}
      <div className="fixed bottom-3 left-1/2 z-40 flex max-w-[calc(100vw-16px)] -translate-x-1/2 items-center gap-3 overflow-x-auto rounded-full border border-slate-700/60 bg-[#0f172a]/95 px-4 py-2.5 text-[11px] font-semibold text-white shadow-2xl backdrop-blur-md [scrollbar-width:none] sm:bottom-6 sm:gap-4 sm:px-5 sm:text-[13px] [&::-webkit-scrollbar]:hidden">
        <span className="flex shrink-0 items-center gap-1.5 whitespace-nowrap text-amber-400">
