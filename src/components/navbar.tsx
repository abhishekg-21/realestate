          ...
          <div className="ml-auto flex items-center gap-[10px] text-[13px] max-md:text-[11px] font-bold">
            {user ? (
              <>
                ...
                {/* Notifications Bell */}
                <button
                  onClick={() => router.push("/app/dashboard/saved-properties")}
                      ...
                      <div className="flex flex-col text-[12px] font-semibold text-[#40515e]">
                        {user.role === "super_admin" ? (
                          ...
                          <>
                            ...
                            <Link href="/app/dashboard/saved-properties" onClick={() => setProfileMenuOpen(false)} className="flex items-center justify-between p-[9px_12px] rounded-[7px] hover:bg-gray-50 hover:text-navy transition-colors">
