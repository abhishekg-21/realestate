...
export const PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    description:
      "A refined high-rise residence with panoramic sea views, generous entertaining spaces and considered interiors in the heart of Worli.",
    amenities: [
      "Sea view",
      "Private lift lobby",
      "Pool & fitness studio",
  ...
  },
  {
    ...
    description:
      "A calm, contemporary villa designed around a landscaped courtyard, with light-filled rooms and effortless indoor-outdoor living.",
    amenities: [
      "Private garden",
      "Covered parking",
      "Gated community",
  ...
  },
  {
    ...
    description:
      "A limited collection of elevated residences, crafted for privacy and set along one of Gurugram’s most connected addresses.",
  ...
  },
  {
    ...
    description:
      "A fully furnished garden-facing loft with a quiet work nook, premium finishes and immediate access to Indiranagar’s best cafés.",
    amenities: [
      "Furnished",
      "Pet friendly",
      "Dedicated workspace",
  ...
  },
  {
    ...
    description:
      "A relaxed Assagao retreat with tropical planting, a private pool and spaces designed for slow days and long dinners.",
    amenities: [
      "Private pool",
      "Housekeeping option",
      "Outdoor kitchen",
  ...
  },
  {
    ...
    description:
      "A characterful city apartment with warm materials, a practical layout and the best of Bandra just outside your door.",
  ...
  },
  {
    ...
    description:
      "A flexible, client-ready office suite with natural light, meeting rooms and a strategic HITEC City address.",
    amenities: [
      "Reception area",
      "Meeting room",
      "24-hour access",
  ...
  },
  {
    ...
    description:
      "A rare residential plot in a low-density enclave, positioned for a future home surrounded by green space.",
    amenities: [
      "Clear title",
      "Road access",
      "Water connection",
